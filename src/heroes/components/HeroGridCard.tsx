...
export const HeroGridCard = ({ hero }: Props) => {
    ...
    //ya siempre utilizar use en vez de useContext esta en buenas practicas en versiones mas recientes
    const { isFavorite, toggleFavorite } = use(FavoriteHeroContext)

    //el slug le gusta mucho a google en vez de poner id es mejor poner texto
    const handleClick = () => {
            ...
            <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1">
                        ...
                        {/* el activeColor se ha modificado en progress */}
